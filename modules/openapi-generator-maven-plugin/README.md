...
|--------|----------|---------------|-------------|
| `verbose` |  `openapi.generator.maven.plugin.verbose` | `false` | verbose mode
...
| `output` |  `openapi.generator.maven.plugin.output` | `${project.build.directory}/generated-sources/openapi` | target output path (Can also be set globally through the `openapi.generator.maven.plugin.output` property)
...
| `engine` | `openapi.generator.maven.plugin.engine` | "mustache" | The name of templating engine to use, "mustache" or "handlebars" (beta)
...
| `skipOverwrite` |  `openapi.generator.maven.plugin.skipOverwrite` | `false` | Specifies if the existing files should be overwritten during the generation.
...
| `supportingFilesToGenerate` |  `openapi.generator.maven.plugin.supportingFilesToGenerate` | all files | A comma separated list of supporting files to generate.
